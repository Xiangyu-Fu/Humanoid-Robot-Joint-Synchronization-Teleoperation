...
# urdf = "src/talos/talos_description/robots/talos_reduced_no_hands.urdf"
urdf = "/home/fu/legged-robots-final-project/src/talos/talos_description/robots/talos_reduced_no_hands.urdf"
# urdf = "/home/kaicheng/leg_final/legged-robots-final-project/src/talos/talos_description/robots/talos_reduced_no_hands.urdf"
path = "src/talos/talos_description/meshes/../.."
...
q_home = np.hstack([np.array([0, 0, 0.85, 0, 0, 0, 1]), q_actuated_home])

q_posture = np.zeros(na)
q_posture[0:6] = np.array([0, 0, -0.44, 0.9, -0.45, 0])
q_posture[6:12] = np.array([0, 0, -0.44, 0.9, -0.45, 0])
q_posture[14:21] = np.array([0, -0.24, 0, -1, 0, 0, 0])
q_posture[21:28] = np.array([0, -0.24, 0, -1, 0, 0, 0])
...
footprint = np.array([lfxp+lfxn, lfyp+lfyn])
...
# Task weights
w_com = 3e1             # weight of center of mass task
w_am = 1e-3             # weight of angular momentum task
w_foot = 5e-1         # weight of the foot motion task: here no motion
w_hand = 5e-1           # weight of the hand motion task
...
# step dimensions
step_size_x = 0.20 # 0.25              # step size in x direction
